...
def create_conversation_session(user_id, thread_id=None, config_name='default'):
    ...
    with app.app_context():
        ...
        db.session.commit()
        print(f"Conversation session created successfully for user {user.username} with session ID {new_session.id}.")

create_conversation_session(user_id='c8475de4-e267-4ef7-bf76-f51138721727', thread_id='thread_HnG5za7m2n2XrzezrVH4RiHW', config_name='default')