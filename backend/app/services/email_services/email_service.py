...
class EmailService:
    ...
    def send_gen_user_email(self, email, title, message_body):
        try:
            ...
            print(f'General user email sent to {email}. Status code: {response.status_code}')
        except Exception as e:
    ...
    def send_sentinel_drone_summary(self, email, summary):
        try:
            ...
            print(f'Sentinel drone summary email sent to {email}. Status code: {response.status_code}')
        except Exception as e:
