...
class MessageService:
    ...
    def get_most_recent_message(cls, data):
        ...
        if most_recent_message:
            ...
            if 'assistant_id' in most_recent_message and most_recent_message['assistant_id'] is not None:
                assistant_reply = most_recent_message['assistant_id'] + ': ' + most_recent_message['content']
