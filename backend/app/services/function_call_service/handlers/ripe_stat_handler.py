...
class RipeStatHandler:
    ...
    def handle_get_address_space_usage(self, arguments):
        ...
        usage_data = self.ripe_stat_service.get_address_space_usage(resource, all_level_more_specifics)
        if usage_data:
    ...
    def handle_get_announced_prefixes(self, arguments):
        ...
        prefixes_data = self.ripe_stat_service.get_announced_prefixes(resource, starttime, endtime, min_peers_seeing)
        if prefixes_data:
    ...
    def handle_get_allocation_history(self, arguments):
        ...
        starttime = arguments.get("starttime", None)
        endtime = arguments.get("endtime", None)
        allocation_data = self.ripe_stat_service.get_allocation_history(resource, starttime, endtime)
        if allocation_data:
    ...
    def handle_get_bgp_updates(self, arguments):
        ...
        updates_data = self.ripe_stat_service.get_bgp_updates(resource, starttime, endtime, rrcs, unix_timestamps)
        if updates_data:
    ...
    def handle_get_asn_neighbours_history(self, arguments):
        ...
        history_data = self.ripe_stat_service.get_asn_neighbours_history(resource, starttime, endtime, max_rows)
        if history_data:
    ...
    def handle_get_country_resource_stats(self, arguments):
        ...
        stats_data = self.ripe_stat_service.get_country_resource_stats(resource, starttime, endtime, resolution)
        if stats_data:
    ...
    def handle_get_iana_registry_info(self, arguments):
        ...
        registry_data = self.ripe_stat_service.get_iana_registry_info(resource, best_match_only)
        if registry_data:
    ...
    def handle_get_routing_history(self, arguments):
        ...
        history_data = self.ripe_stat_service.get_routing_history(resource, starttime, endtime, min_peers)
        if history_data:
    ...
    def handle_get_routing_status(self, arguments):
        ...
        min_peers_seeing = arguments.get("min_peers_seeing", 10)
        status_data = self.ripe_stat_service.get_routing_status(resource, timestamp, min_peers_seeing)
        if status_data:
    ...
    def handle_get_rpki_validation_status(self, arguments):
        ...
        validation_data = self.ripe_stat_service.get_rpki_validation_status(resource, prefix)
        if validation_data:
    ...
    def handle_get_rpki_history(self, arguments):
        ...
        history_data = self.ripe_stat_service.get_rpki_history(resource, family, resolution, delegated)
        if history_data:
    ...
    def handle_get_zonemaster_details(self, arguments):
        ...
        resource = arguments.get("resource", None)
        method = "details"
        zonemaster_details_data = self.ripe_stat_service.get_zonemaster(resource, method)
    ...
    def handle_get_mlab_bandwidth(self, arguments):
        ...
        starttime = arguments.get("starttime", None)
        endtime = arguments.get("endtime", None)
        bandwidth_data = self.ripe_stat_service.get_mlab_bandwidth(resource, starttime, endtime)
        if bandwidth_data:
            ...
            response += f"Resource: {bandwidth_data.get('data', {}).get('resource', '')}\n"
            response += "---\n"
        else:
            self.logging_utility.warning('Failed to retrieve M-Lab bandwidth measurements')
    ...
    def handle_get_mlab_clients(self, arguments):
        ...
        starttime = arguments.get("starttime", None)
        endtime = arguments.get("endtime", None)
        clients_data = self.ripe_stat_service.get_mlab_clients(resource, starttime, endtime)
        if clients_data:
            ...
            response += f"Resource: {clients_data.get('data', {}).get('resource', '')}\n"
            response += "---\n"
        else:
