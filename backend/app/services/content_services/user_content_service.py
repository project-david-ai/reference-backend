...
from backend.app.utils.handle_user_files import handle_user_files, handle_user_files_simple
...
class UserContentService:
    ...
    def handle_user_content(self, user_id, thread_id):
        ...
        file_urls, file_objects = handle_user_files(upload_service, user_id, thread_id, entity=self.entity)
